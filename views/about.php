    ...
    <body>
        ...
        <div class="s-promo-block-v3 g-bg-position--center g-fullheight--sm" style="background: url('../img/1920x1080/09.jpg');">
            <div class="container g-ver-center--sm g-padding-y-125--xs g-padding-y-0--sm">
                <div class="g-margin-t-30--xs g-margin-t-0--sm g-margin-b-30--xs g-margin-b-70--md">
                    <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-50--lg g-color--white">Customer Credit Integrity <br> of The Year.</h1>
                </div>
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                                <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".4s">
                                    <p class="g-font-size-18--xs g-color--white-opacity">It is the cheapest at ZIPEST.<br>In other words, ZIPEST Ventures Limited<br>sells her products at very reasonable rates/prices.</p>
                                </div>
                            </div>
                            <div class="col-sm-5 col-sm-offset-1">
                                <div class="clearfix">
                                    ...
                                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                                        <span class="s-promo-block-v3__month g-font-size-18--xs g-font-size-22--lg g-font-weight--300 g-color--white-opacity-light">August</span>
                                        <span class="s-promo-block-v3__year g-font-size-18--xs g-font-size-22--lg g-font-weight--300 g-color--white-opacity-light">2008</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 col-sm-pull-8">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".5s">
                            <a class="js__popup__youtube" href="https://#" title="Intro Video">
        ...
        <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--sm">
            <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-60--xs g-margin-b-100--md">
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="../img/400x500/05.jpg" alt="Opening Ceremony Picture">
                    </div>
                </div>
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col g-margin-b-60--xs g-margin-b-0--md">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".2s">
                        <img class="img-responsive" src="../img/400x500/01.jpg" alt="Opening Ceremony Picture">
                    </div>
                </div>
                <div class="col-sm-1"></div>
                <div class="col-sm-5 g-hor-centered-row__col">
                    <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">2007 - PRESENT</p>
                    <h2 class="g-font-size-32--xs g-font-size-36--sm g-margin-b-25--xs">OUR STAR IS BORN</h2>
                    <p class="g-font-size-18--sm">ZIPEST was established in the year 2007, with principal aim of contributing to the economic growth of Ogun State in particular and Nigeria in general, especially in the provision of avenues for job creation and employment opportunities for some of the unemployed youths of Ogun State and Nigeria.</p>
                </div>
            </div>
        </div>
        <!-- End About -->
        ...
        <div class="g-bg-color--primary-ltr">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-100--xs">
                    ...
                    <h2 class="g-font-size-32--xs g-font-size-36--md g-color--white">How we Work</h2>
                </div>
                <ul class="list-inline row g-margin-b-100--xs">
                    ...
                    <li class="col-sm-3 col-xs-6 g-full-width--xs s-process-v1 g-margin-b-60--xs g-margin-b-0--md">
                        <div class="center-block g-text-center--xs">
                            ...
                            <div class="g-padding-x-20--xs">
                                <h3 class="g-font-size-18--xs g-color--white">Discover</h3>
                                <p class="g-color--white-opacity">This is where we discover pressing issues in our community and think of a possible solution.</p>
                            </div>
                        </div>
                    </li>
                    <!-- End Process -->
                    ...
                    <li class="col-sm-3 col-xs-6 g-full-width--xs s-process-v1 g-margin-b-60--xs g-margin-b-0--md">
                        <div class="center-block g-text-center--xs">
                            ...
                            <div class="g-padding-x-20--xs">
                                <h3 class="g-font-size-18--xs g-color--white">Contribute</h3>
                                <p class="g-color--white-opacity">We then contribute positively to the economic growth of the community.</p>
                            </div>
                        </div>
                    </li>
                    <!-- End Process -->
                    ...
                    <li class="col-sm-3 col-xs-6 g-full-width--xs s-process-v1 g-margin-b-60--xs g-margin-b-0--sm">
                        <div class="center-block g-text-center--xs">
                            ...
                            <div class="g-padding-x-20--xs">
                                <h3 class="g-font-size-18--xs g-color--white">Make Provisions</h3>
                                <p class="g-color--white-opacity">We provide avenues for job creation and employment opportunities for some of the unemployed youths of our community.</p>
                            </div>
                        </div>
                    </li>
                    <!-- End Process -->
                    ...
                    <li class="col-sm-3 col-xs-6 g-full-width--xs s-process-v1">
                        <div class="center-block g-text-center--xs">
                            ...
                            <div class="g-padding-x-10--xs">
                                <h3 class="g-font-size-18--xs g-color--white">Method</h3>
                                <p class="g-color--white-opacity">We achieve this through our various products.</p>
                            </div>
                        </div>
                    </li>
                    <!-- End Process -->
                    ...
                    <div class="center-block g-box-shadow__dark-lightest-v1 g-width-100-percent--xs g-width-400--lg">
                        ...
                        <div class="g-position--overlay g-padding-x-30--xs g-padding-y-30--xs g-margin-t-o-60--xs">
                            <div class="g-bg-color--primary g-padding-x-15--xs g-padding-y-10--xs g-margin-b-20--xs">
                                <h4 class="g-font-size-22--xs g-font-size-26--sm g-color--white g-margin-b-0--xs">Oshin Babatunde A.</h4>
                            </div>
                            <p class="g-font-weight--700 g-text-center--xs">CEO</p>                            
                        </div>
                    </div>
                    <!-- End Speaker -->
                </div>
        ...
        <div class="row g-row-col--0">
            ...
            <div class="col-md-3 col-xs-6 g-full-width--xs">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">                    
                    <div class="s-team-v1">
                        <img class="img-responsive g-width-100-percent--xs" src="../img/400x400/09.jpg" alt="Image">
                        <div class="g-text-center--xs g-bg-color--white g-padding-x-30--xs g-padding-y-40--xs">
                            <h2 class="g-font-size-18--xs g-margin-b-5--xs">Hon. Yusuf  Adekunle</h2>
                            <span class="g-font-size-15--xs g-color--text"><i>ZVL General Secretary</i></span>
                        </div>
                    </div>                    
                </div>
            </div>
            <div class="col-md-3 col-xs-6 g-full-width--xs">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">                    
                    <div class="s-team-v1">
                        ...
                        <div class="g-text-center--xs g-bg-color--white g-padding-x-30--xs g-padding-y-40--xs">
                            <h2 class="g-font-size-18--xs g-margin-b-5--xs">Oshin Oluwole</h2>
                            <span class="g-font-size-15--xs g-color--text"><i>ZVL Admin Director</i></span>
                        </div>
                    </div>                    
                </div>
            </div>
            ...
            <div class="col-md-3 col-xs-6 g-full-width--xs">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".2s">
                    ...
                    <div class="s-team-v1">
                        ...
                        <div class="g-text-center--xs g-bg-color--white g-padding-x-30--xs g-padding-y-40--xs">
                            <h3 class="g-font-size-18--xs g-margin-b-5--xs">Oluwakemi Medahunsi</h3>
                            <span class="g-font-size-15--xs g-color--text"><i>ZVL Irewon - Manager</i></span>
                        </div>
                    </div>
                    <!-- End Team -->
                </div>
            ...
            <div class="col-md-3 col-xs-6 g-full-width--xs">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".3s">
                    ...
                    <div class="s-team-v1">
                        ...
                        <div class="g-text-center--xs g-bg-color--white g-padding-x-30--xs g-padding-y-40--xs">
                            <h4 class="g-font-size-18--xs g-margin-b-5--xs">Rahman Olayinka</h4>
                            <span class="g-font-size-15--xs g-color--text"><i>ZVL Abeokuta Road - Manager</i></span>
                        </div>
                    </div>
                    <!-- End Team -->
                </div>
            ...
            <div class="col-md-3 col-xs-6 g-full-width--xs">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".4s">
                    ...
                    <div class="s-team-v1">
                        ...
                        <div class="g-text-center--xs g-bg-color--white g-padding-x-30--xs g-padding-y-40--xs">
                            <h4 class="g-font-size-18--xs g-margin-b-5--xs">Idebi Adeola</h4>
                            <span class="g-font-size-15--xs g-color--text"><i>ZVL Sabo - Manager</i></span>
                        </div>
                    </div>
                    <!-- End Team -->
                </div>
            ...
            <div class="col-md-3 col-xs-6 g-full-width--xs">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".4s">
                    ...
                    <div class="s-team-v1">
                        ...
                        <div class="g-text-center--xs g-bg-color--white g-padding-x-30--xs g-padding-y-40--xs">
                            <h4 class="g-font-size-18--xs g-margin-b-5--xs">Oguntolu Sunday</h4>
            ...
            <div class="col-md-3 col-xs-6 g-full-width--xs">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".3s">
                    ...
                    <div class="s-team-v1">
                        ...
                        <div class="g-text-center--xs g-bg-color--white g-padding-x-30--xs g-padding-y-40--xs">
                            <h4 class="g-font-size-18--xs g-margin-b-5--xs">Amata Harrison</h4>
                            <span class="g-font-size-15--xs g-color--text"><i>ZVL Awokoya - Manager</i></span>
                        </div>
                    </div>
                    <!-- End Team -->
                </div>
        ...
        <div class="g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-container--sm">
                <div class="g-text-center--xs g-margin-b-80--xs">
                    <h2 class="g-font-size-32--xs g-font-size-36--sm">Follow Us</h2>
                    <p class="g-font-size-18--md">You can follow us on our social media platforms</p>
                </div>
            </div>
            <div class="g-container--md">
                <!-- Swiper Clients -->
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".2s">
                                <a href="https://www.instagram.com/oshin_white" target="_blank"><img class="s-clients-v1" src="../img/clients/02-dark.png" alt="Clients Logo"></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".5s">
                                <a href="https://web.facebook.com/Zipest-Ventures-Limited-174820842543804/?hc_ref=SEARCH&fref=nf" target="_blank"><img class="s-clients-v1" src="../img/clients/05-dark.png" alt="Clients Logo"></a>
                            </div>
                        </div>
                    </div>
                </div>
